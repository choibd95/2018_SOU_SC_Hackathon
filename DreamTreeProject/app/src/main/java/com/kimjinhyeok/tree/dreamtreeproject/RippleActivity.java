...
public class RippleActivity extends AppCompatActivity
    ...
    AQuery aq;
    static EditText board_title_input;
    static EditText board_content_input;
...
//        findViewById(R.id.image_container).setOnClickListener(handler);
//
//        image_container = (LinearLayout) findViewById(R.id.image_container);
        ...
        board_title_input.requestFocus();
        board_title_input.setNextFocusDownId(R.id.board_content_input);


        InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);

      //  imm.showSoftInput(board_title_input, 0);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA && resultCode == RESULT_OK) {
            ...
            try {
                ...
                /** uri로 이미지 파일 경로 가져오기 */
                Uri fileUri = getImageUri(RippleActivity.this, bmRotated);
                ...
                /** */
                ImageView myImageView = new ImageView(RippleActivity.this);
        ...
        if (requestCode == GALLERY && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                String tempPath = getPath(selectedImageUri, RippleActivity.this);
                Bitmap bm;
...
//        params.put("midx", viewFragment.Midx);
//        params.put("board_title", board_title_input.getText());
//        params.put("board_content", board_content_input.getText());



        if(board_title_input.getText().toString().equals(""))

        {

            Toast.makeText(context, "닉네임을 입력해주세요", Toast.LENGTH_LONG).show();
        }else if(board_content_input.getText().toString().equals(""))
        {

            Toast.makeText(context, "내용을 입력해주세요", Toast.LENGTH_LONG).show();
        }else
        {
            http.getInstance().nick = board_title_input.getText().toString();
            http.getInstance().content = board_content_input.getText().toString();

            http.urlp = 10;
            http.getInstance().doAction2();

            Toast.makeText(context, "리뷰 작성완료", Toast.LENGTH_SHORT).show();
            finish();
        }
...
//                Intent intent  = new Intent(RippleActivity.this, DetailActivity.class);
//                startActivity(intent);
//            }
//        });
